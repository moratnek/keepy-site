...
- 料金・機能の記述は**アプリの実態と一致させる**（無料枠=サブスク3件/カード1枚/資産1件・**¥3,480 買い切り**）。📜 2026-09-11 に ¥2,480 → ¥3,480 へ値上げ済み（この行は 2026-09-20 まで ¥2,480 のままだった＝**従うと公開中のページを古い価格に戻してしまう**）
...
## ✅ 完了（2026-09-11）— この節は履歴です

> ダウンロード導線の公開（1.0＝2026-08-23）と ¥2,480 → ¥3,480 の値上げ（2026-09-11）は**どちらも完了**。
> 実測（2026-09-20）＝公開中の index.html に実 URL が 2 本・「準備中」0 件・`¥3,480` が 2 か所・`¥2,480` は 0 件。

## 📜 公開時に残っていた作業（App Store 審査通過後）
